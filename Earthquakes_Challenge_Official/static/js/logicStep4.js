...
L.control.layers(baseMaps, overlays).addTo(map); // here we've called the the baseMaps variable and added it to our map
...
d3.json(quakeData).then(function(data) {
    console.log(data);
    // add the style info function before the layers get added to the map
    ...
    // add a conditional expression to have the colors of the markers vary
